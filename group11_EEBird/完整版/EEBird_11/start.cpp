...
bool handleEvent( SDL_Event* e )
{
	...
	if( e->type == SDL_MOUSEMOTION || e->type == SDL_MOUSEBUTTONDOWN || e->type == SDL_MOUSEBUTTONUP )
	{
		...
		if( x>start_lx && x<start_rx )
		{
            ...
            {
                if( e->type == SDL_MOUSEBUTTONDOWN ) {Mix_PlayChannel( -1, gclick, 0 ); return true;}
            }
		}
		...
		if( x>info_lx && x<info_rx )
		{
            ...
            {
                if( e->type == SDL_MOUSEBUTTONDOWN ) {Mix_PlayChannel( -1, gclick, 0 ); infoAppear=true;return false;}
            }
		}
	}
	return false;
